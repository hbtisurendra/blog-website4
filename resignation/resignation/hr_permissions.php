...
.middletable{ width:880px; margin:0 auto;    clear: both;}
...
<span class="title">HR Permissions</span></div>
...
?>
<form name="form1" action="<?php echo $base_url;?>hr_permissions_insert.php" method="POST" >




<span style='font-size:14px;'><b>HR-Access:</b></span>
<table width="880" cellpadding="2" class="demo back" style="margin-top:15px;border-radius:6px;">
...
<input type="hidden" name='id2' value="<?php echo $id;?>">
	<tr><th>HR Name</th><th>Leave Post Access</th><th>Action</th></tr>
	<tr>
	<td>
	<select name="manager_name" class="selectbox7">
	<?php $query="SELECT * FROM hr_permissions WHERE empid!='000004' ";
	$res=mysql_query($query);
	while($val=mysql_fetch_array($res))
	{
		$name=$val['name'];
		$empid=$val['empid'];
		echo "<option value='$empid'>$name($empid)</option>";
	}
	?>
...
<br/>
<table width='880' class="demo back" cellpadding='2' border='1px' style='margin-top:15px;border-radius:6px;margin:0 auto;'>
<tr><th>Name</th><th>Permissions</th></tr>
<?php $query4="SELECT * FROM hr_permissions WHERE permission='1' ";
	$res4=mysql_query($query4);
	
	while($val=mysql_fetch_array($res4))
	{
		echo "<tr>";
		echo "<td>";
		echo $val['name'];
...
<br/><br/>
<form name="form2" action="<?php echo $base_url;?>hr_permissions_insert2.php" method="POST" onSubmit="return validate();">




<span style='font-size:14px;margin-left: 62px;'><b>Leave Post Date Extend:</b></span>
<table width="880" cellpadding="2" class="demo back" style="margin-top:18px;border-radius:6px;margin:0 auto;">
	...
	<tbody>
<input type="hidden" name='id2' value="<?php echo $id;?>">
	<tr><th>Department</th><th>Month</th><th>Year</th><th>Date</th><th>Time</th><th>Action</th></tr>
	<tr>
	<td>
	HR-Department
	</td>

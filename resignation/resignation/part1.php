...
{
?>
<li><a  href="javascript:void(0)" onclick="golink('hr.php?id=<?php echo $id;?>&&status=')"><img src="images/3.jpg" title="HR View" width="64" height="58" /></a></li>
<?php } ?>
</ul>
...
$show_inf="SELECT * FROM user_regination WHERE  empid='$id' AND reg_status='Pending'";
...
$row41=mysql_fetch_array($result2);	
 ?>
<td>
<a  href="javascript:void(0)" onclick="golink('leave_view.php?id=<?php echo $row4['id']; ?>&& empid=<?php echo $id; ?>&&status=')" >APP-<?php echo $row4['id'];?></a>
</td>

...
$show_inf="SELECT * FROM user_regination WHERE manager_id='$id' AND reg_status='Pending'";
$result=mysql_query($show_inf);
$num_rows_inf=mysql_num_rows($result);
if($num_rows_inf>=1)
{
?>
<tr><th >Application No</th><th>Associate Type</th><th>Code</th><th>Name</th><th>Location</th><th>Site</th><th>Associate Date</th><th>Manager Date</th><th>Reporting Manager</th><th>Status</th><th>Action</th></tr>
<?php }?>
</thead>
<tfoot></tfoot>
<tbody>
...
$row41=mysql_fetch_array($result2);
 ...
 ?>
	...
	<td>
	<a href="leave_view.php?id=<?php echo $main_id;?>&& empid=<?php echo $id;?>">
	<input style="font-size: 11px;" type="button" name="button" value="Approve/Reject" id="<?php echo $main_id;?>" rel="<?php echo $id;?>"></a></td>
</tr>
<?php 
